...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            render = PhotoImage(file='mainpic.png')
...
class PageThree(tk.Frame):
    ...
    def capimg(self):
        ...
        "During capturing please move you're facial like look different sides and blinking eyes. Steady or not move is difficult for real time facial recognizer.")
        x = start_capture(self.controller.active_name)
        self.controller.num_of_images = x
        self.numimglabel.config(text=str("Number of images captured = "+str(x)))

    def trainmodel(self):
        if self.controller.num_of_images < 199:
...
app = MainUI()
app.iconphoto(False, tk.PhotoImage(file='pngwing.com (3).png'))
app.mainloop()
